    ...
    return (
        <div className=' px-14 max-md:px-5 pt-12 max-md:pt-10 relative mx-auto pb-24'>
            ...
            <form className='flex flex-col gap-4'>
                ...
                <button type='submit' className='rounded-lg text-sm max-md:text-base px-4 py-2 max-md:py-4 bg-[#186BAD] mt-5 text-white hover:bg-[#186BAD]/70 transition-all duration-300 font-semibold max-w-max max-md:max-w-full'>Send Invitation</button>
            </form>
