...
function SideBar() {
  ...
  const [isDropdownfiveOpen, setIsDropdowntfiveOpen] = useState(false);

  const toggleDropdownfive = () => {
    setIsDropdowntfiveOpen(!isDropdownfiveOpen);
  };
    ...
    <div className="max-lg:hidden bg-gradient-to-b from-[#1B87E1E0]/[88%] to-[#0C2E4A] w-52 flex flex-col text-[#FFFFFF] text-sm">
      <div className="pt-14 pb-4 px-6 h-screen overflow-y-auto flex flex-col">
        <div className="mb-10 w-full">
          <button
            className="flex w-full outline-none items-center gap-2 bg-[#1F70B2] hover:bg-[#1F70B2]/50 transition-all cursor-pointer px-2 py-2 border border-[#FFFFFF]/10"
          ...
          >
            <ul>
              <li>
                <NavLink to="/">
                  <span className="flex items-center justify-center gap-2 bg-[#1D8EED]/[78%] hover:bg-[#1F70B2]/10 transition-all cursor-pointer px-2 py-2 border border-[#FFFFFF]/10">
                    Overview
                  </span>
                </NavLink>
              </li>
        ...
        <span className="flex items-center gap-2 bg-[#1F70B2] hover:bg-[#1F70B2]/10 transition-all cursor-pointer px-2 py-2 border border-[#FFFFFF]/10">
          <TbMessage />
          Messaging
          <FaAngleRight />
        </span>
        ...
        <span className="flex items-center gap-2 bg-[#1F70B2] hover:bg-[#1F70B2]/10 transition-all cursor-pointer px-2 py-2 mt-10 border border-[#FFFFFF]/10">
          <MdOutlineFeedback />
          Feedback
        </span>
        ...
        <NavLink to="/refer">
          <button className="py-3 mb-16 w-full bg-[#186BAD] hover:bg-[#186BAD]/50 transition-all  rounded">
            Refer & Earn
          </button>
        </NavLink>
      </div>
