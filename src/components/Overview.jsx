...
import UpcomingClasseChart from "./UpcomingClassChart";
    ...
    <>
      <div className="px-14 max-md:px-5 pt-12 max-md:pt-0 relative mx-auto pb-24">
        ...
        <div className="flex mx-auto gap-10 max-lg:flex-col">
          ...
          {/* <div className='max-md:hidden max-w-full space-y-4 border-2 rounded-lg border-neutral-100 bg-neutral-100 p-5'>
                        <div className='flex justify-between w-full md:pb-5 items-center '>
          ...
          <div className="max-md:hidden min-w-[300px] border-2 rounded-lg border-neutral-100 bg-[#ffffff] p-5 space-y-4">
            <div className="pb-5 flex justify-between items-center">
              <h2 className="font-bold text-2xl ">Assignments</h2>
              <p className="text-sm font-semibold text-[#1D8EED] cursor-pointer">
                See All
              </p>
            </div>
            <div className="flex border-b-2 md:max-w-max pb-[1.35rem] space-x-8 items-center">
              <div className="text-2xl text-[#0052B4]">
                <HiClipboardList />
              </div>
              <div className="flex flex-col">
          ...
          {/* Mobile version */}
          <div className="md:hidden max-w-full space-y-4 max-md:rounded-lg max-md:bg-[#FFFFFF] p-5">
        ...
        <div className="gap-5 max-md:flex-col grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-10">
          <div className="max-md:hidden border-2 rounded-lg border-neutral-100 bg-[#ffffff] px-5">
          ...
          {/* Mobile version */}
          <div className="md:hidden max-md:rounded-lg max-md:bg-[#FFFFFF] p-5">
            <div className="pb-5 pt-8 flex justify-between items-center">
              <h2 className="font-bold text-xl ">My Tutors</h2>
              <p className="text-sm font-semibold text-[#09BCFF] cursor-pointer">
                See All
              </p>
            </div>
            <MyTutors />
          ...
          <div className="max-md:hidden max-w-[400px] border-2 rounded-lg border-neutral-100 bg-[#ffffff] px-5 space-y-4">
            <div className="pt-8 border-b-2 pb-5 flex justify-between items-center">
              <h2 className="font-bold text-xl ">Messages</h2>
              <p className="text-sm semibold text-[#1D8EED] cursor-pointer">
                See All
              </p>
            </div>
            <div className="flex justify-between border-b w-full pb-2.5 items-start">
              <div className="text-xl text-[rgb(0,82,180)] font-semibold w-11 py-2 px-2 rounded-xl bg-[#F0F7FF] uppercase">
                aa
              </div>
              <div className="flex flex-col w-2/3">
                ...
                <span className="text-xs text-[#9E9E9E]">
                  Hello, Mr John i am yet to get your...
                </span>
              </div>
              <p className="text-[#8A8A8A] text-xs">10:25 am</p>
            </div>
            <div className="flex justify-between border-b w-full pb-2.5 items-start">
              <div className="text-xl text-[#0052B4] font-semibold w-11 py-2 px-2 rounded-xl bg-[#F0F7FF] uppercase">
                bp
              </div>
              <div className="flex flex-col w-2/3">
                <span className="font-semibold text-sm text-[#333333]">
            ...
            <div className="flex justify-between w-full pb-2.5 items-start">
              <div className="max-w-max">
                <img
                  src={man}
                  alt=""
                  className="rounded-full w-auto max-h-12 mr-3"
                />
              </div>
              <div className="flex flex-col w-2/3">
                <span className="font-semibold text-sm text-[#333333]">
                ...
                <span className="text-xs text-[#9E9E9E]">
                  Hi there! I wanted to enquire about the list of the class...
                </span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <p className="text-[#8A8A8A] text-xs">10:25</p>
                <span className="max-h-10 w-auto text-white px-2 py-1 rounded text-xs bg-[#0162E8]">
                  2
                </span>
              </div>
            </div>
          ...
          {/* mobile version */}
          <div className="md:hidden max-w-full space-y-4">
